...
import nextbeat.local_job_runner
import nextbeat.nextrun_job_runner
from nextbeat.jobs import JobRunnerPredicate, JobRunner
...
_JOB_RUNNER_TYPES: Dict[str, Type] = {
    "local": nextbeat.local_job_runner.LocalJobRunner,
    "nextrun": nextbeat.nextrun_job_runner.NextRunJobRunner,
}
