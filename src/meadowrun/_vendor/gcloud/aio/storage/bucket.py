...
class Bucket:
    ...
    async def blob_exists(
        self, blob_name: str, session: Optional[Session] = None
    ) -> bool:
        try:
    ...
    async def list_blobs(
        self, prefix: str = "", session: Optional[Session] = None
    ) -> List[str]:
    ...
    async def get_metadata(
        self, params: Optional[Dict[str, Any]] = None, session: Optional[Session] = None
    ) -> Dict[str, Any]:
