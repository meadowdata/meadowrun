...
@REM minikube image load meadowrun/meadowrun:%MEADOWRUN_VERSION%-py3.9
...
@REM docker push meadowrun/meadowrun:%MEADOWRUN_VERSION%-py3.8
...
@REM docker push meadowrun/meadowrun:%MEADOWRUN_VERSION%-py3.7
