...
docker build -t meadowrun/cuda-conda:conda4.12.0-mamba-cuda11.6.2-cudnn8-ubuntu20.04 -f CudaCondaDockerfile .
docker push meadowrun/cuda-conda:conda4.12.0-mamba-cuda11.6.2-cudnn8-ubuntu20.04
