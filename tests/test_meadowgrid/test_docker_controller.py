        ...
        async with aiodocker.Docker() as client:
            ...
            print(
                await _does_digest_exist_locally(
                    client,
                    "python",
                    "sha256:76eaa9e5bd357d6983a88ddc9c4545ef4ad64c50f84f081ba952c7ed08e3bdd6",
                )
            )
            ...
            print(
                await _does_digest_exist_locally(
                    client,
                    "python",
                    "sha256:4157d139faf3ec4c3742c2980d3fd3675608dbf75384a756f8dc0e825e54d492",
                )
            )
...
def manual_test_pull_digest():
    async def run():
        ...
        await pull_image(
            "python@sha256:76eaa9e5bd357d6983a88ddc9c4545ef4ad64c50f84f081ba952c7ed08e3bdd6",
            None,
        )
        ...
        await pull_image(
            "gcr.io/kaniko-project/executor@sha256:8504bde9a9a8c9c4e9a4fe659703d265697a36ff13607b7669a4caa4407baa52",
            None,
        )
        # with authentication at DockerHub
        await pull_image(
            "[your username]/test1@sha256:4157d139faf3ec4c3742c2980d3fd3675608dbf75384a756f8dc0e825e54d492",
            ("[your username]", "[your password]"),
        )
        # with authentication at AWS ECR
        await pull_image(
            "012345678910.dkr.ecr.us-east-2.amazonaws.com/test1@sha256:9c5098aa89084bfe4a22c690e045c34b03618e6560a890872fae2305a6f49da3",
            ("AWS", "`aws ecr get-login-password --region [region]`"),
        )
