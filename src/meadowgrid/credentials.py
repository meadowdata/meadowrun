...
from meadowgrid.meadowgrid_pb2 import ServerAvailableFile, AwsSecret, Credentials
...
def get_docker_credentials(
    ...
    registry_domain, repository_name = meadowgrid.docker_controller.get_registry_domain(
        repository
    )
