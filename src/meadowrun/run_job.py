...
class Deployment:
    ...
    def git_repo(
        ...
        :param repo_url: e.g. :code:`"https://github.com/meadowdata/test_repo"`
        :param branch: defaults to :code:`"main"` if neither branch nor commit are
            specified.
        :param commit: can be provided instead of branch to use a specific commit hash,
            e.g. :code:`"d018b54"`
        :param path_to_source: e.g. "src/python" to use a subdirectory of the repo
        :param conda_yml_file: a file (relative to the repo, note that this IGNORES
            :code:`path_to_source`) file generated by :code:`conda env export`, e.g.
            :code:`envs/myenv.yml`. This file will be used to generate the environment
            to run in.
...
class AllocCloudInstance(Host):
    ...
    :param interruption_probability_threshold: Specifies what interruption probability
...
class AllocCloudInstances:
    ...
    :param logical_cpu_required:
    :param memory_gb_required:
    :param interruption_probability_threshold:
    :param num_concurrent_tasks: The number of workers to launch. In the context of a
        :func:`~meadowrun.run_map` call, this can be less than or equal to the number of
        args/tasks.
    :param region_name:
    """
...
async def run_function(
    ...
    :param function: A reference to a function (e.g.
        :code:`package.module.function_name`), a lambda, or a string like
    ...
    :param kwargs: Passed to the function like :code:`function(**kwargs)`
    """
...
async def run_map(
    ...
    """
    Equivalent to :code:`map(function, args)`, but runs distributed and in parallel.
