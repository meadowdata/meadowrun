...
from meadowgrid.meadowgrid_pb2 import GridTask, ProcessState, GridTaskStateResponse
from meadowgrid.shared import pickle_exception


_REQUEST_QUEUE_NAME_PREFIX = "meadowgridTaskRequestQueue-"
_RESULT_QUEUE_NAME_PREFIX = "meadowgridTaskResultQueue-"
